...
MNI_152_bone = os.path.join(os.getcwd(),'code/MNI152_T1_1mm_bone.nii.gz')
MNI_152 = os.path.join(os.getcwd(),'code/MNI152_T1_1mm.nii.gz')
bspline_path = os.path.join(os.getcwd(), 'code/Par0000bspline.txt')
